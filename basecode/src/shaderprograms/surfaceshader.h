...
public:
    ...
    int uniCamera_pos; //A handle to a uniform vec3 in a surface shader that represents your camera's position in world space.
...
public:
    ...
    //Self implement, which is used to pass camera to the uniform variable inside the shader
